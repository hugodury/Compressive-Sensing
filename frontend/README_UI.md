...
- comparaison des méthodes et sweeps de ratios
- génération des tableaux section 6 (CSV)
- onglet Patchs : **une image** avec la grille B×B sur l’image recadrée (`grille_sur_image`)
